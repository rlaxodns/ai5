...
for base_model, input_size in model_list:
    ...
    model.add(Dense(10, activation='softmax'))  # CIFAR-10에 맞는 출력층 추가
...
"""
Model: xception, Loss: 18.6662, Accuracy: 0.1645
Model: vgg19, Loss: 2.3035, Accuracy: 0.1000
Model: resnet50, Loss: nan, Accuracy: 0.1000
Model: resnet101, Loss: nan, Accuracy: 0.1000
"""