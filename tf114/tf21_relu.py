...
w2 = tf.compat.v1.Variable(tf.random_normal([10, 10]), name='weight2')
...
w3 = tf.compat.v1.Variable(tf.random_normal([10, 3]), name='weight3')
b3 = tf.compat.v1.Variable(tf.zeros([3]), name='bias3')

#######################렐루 적용##############################
layer3 = tf.compat.v1.nn.relu(tf.compat.v1.matmul(layer2, w3) + b3) #selu, leaky_relu, elu
